...
public class FLEX_HASH {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //System.out.println("HASH: "+ HASH("C:\\Users\\nikit\\IdeaProjects\\HashMachine\\src\\psw.txt"));
    ...
    static int ARRAY_SIZE = 128; // Size of hash can be between 16 and 1024, smaller hash is for small data and otherwise. 128 for best result
